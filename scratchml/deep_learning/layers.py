...
import numpy as np
import copy
from sratchml.deep_learning.activation_functions import Sigmoid, ReLU, SoftPlus, LeakyReLU
from sratchml.deep_learning.activation_functions import TanH, ELU, SELU, Softmax
