...
from sratchml.utils import k_fold_cross_validation_sets, normalize, mean_squared_error
from sratchml.utils import train_test_split, polynomial_features, Plot


def main():

    # Load temperature data
    data = pd.read_csv('sratchml/data/buffalotemp.txt', sep="\t")
